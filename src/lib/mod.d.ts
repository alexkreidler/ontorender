...
declare module "@graphy/memory.dataset.fast" {
    ...
    export class GraphyMemoryDataset
        extends Duplex
        implements Dataset, Stream<Quad> {
        read(): Quad | null
        addListener(
            event: string | symbol,
        ...
        forEach(
            iteratee: (quad: Quad, dataset: Dataset<Quad, Quad>) => void
        ): void
    ...
    function DatasetCreator(): GraphyMemoryDataset
